                            ...
                            <div class="col-md-12">
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" style="background-image:url({{ URL::to('/') }}/public/images/drag1.png)"></div>
                                        <div class="swiper-slide" style="background-image:url({{ URL::to('/') }}/public/images/drag3.png)"></div>
                                        <div class="swiper-slide" style="background-image:url({{ URL::to('/') }}/public/images/drag2.png)"></div>
                                    </div>
                            ...
                            <div class="screen01 roomy-50">
                                <div class="col-md-6">
                                    <div class="screen01_img text-center">
                                        ...
                                        <img src="{{ URL::to('/') }}/public/images/screen01.png" alt="" />
                                ...
                                <div class="col-md-6">
                                    <div class="screen01_content m-top-100">
                                        <div class="screen01_content_img ">
                                            <img src="{{ URL::to('/') }}/public/images/cloud1.png" alt="" />
                                        </div>
                            ...
                            <div class="screen02 roomy-50 m-top-100">
                                <div class="col-md-6 col-md-push-6">
                                    <div class="screen02_img text-center">
                                        ...
                                        <img src="{{ URL::to('/') }}/public/images/screen02.png" alt="" />
                                ...
                                <div class="col-md-6 col-md-pull-6">
                                    <div class="screen02_content m-top-100">
                                        <div class="screen02_content_img ">
                                            <img src="{{ URL::to('/') }}/public/images/sun1.png" alt="" />
                                        </div>
                                        <h2 class="m-top-40">When the clouds</h2>
                            ...
                            <div class="screen03 roomy-50 m-top-100">
                                <div class="col-md-6">
                                    <div class="screen03_img text-center">
                                        ...
                                        <img src="{{ URL::to('/') }}/public/images/screen03.png" alt="" />
                                ...
                                <div class="col-md-6">
                                    <div class="screen03_content m-top-100">
                                        <div class="screen03_content_img ">
                                            <img src="{{ URL::to('/') }}/public/images/rainy1.png" alt="" />
                                        </div>
